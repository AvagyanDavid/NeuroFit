...
class _ThirdLevelState extends State<ThirdLevel> {
  ...
  void showResultDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text(grac),
          content: const Text(completelevel),
          actions: [
            Center(
              child: Column(
                ...
                children: [
                  Theme(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text(continuelevel),
                      onPressed: () {
  ...
  // onInsert(timer) async {
  //   Database db = await DBHelper().db;
  //   int id = await db.insert('Statistic', {'time': timer});
  // }
